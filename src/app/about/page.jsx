...
<motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
  ...
  <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
    ...
    <div
      ...
      <div className="flex flex-col gap-12 justify-center">
        ...
        {/* BIOGRAPHY DESC */}
        <p className="text-lg">
  Hi, I&rsquo;m Moses, a passionate Full Stack Developer with expertise in crafting dynamic, scalable, and
  ...
  interfaces or architecting robust back-end systems, I&rsquo;m driven by the challenge of turning ideas into
  ...
  in this ever-evolving industry. Let&rsquo;s build something amazing together!
        ...
        <motion.svg initial={{ opacity: 0.2, y: 0 }} animate={{ opacity: 1, y: "10px" }}
          transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }} viewBox="0 0 24 24" fill="none"
      ...
      <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
        {/* SKILL TITLE */}
        <motion.h1 initial={{ x: "-300px" }} animate={isSkillRefInView ? { x: 0 } : {}} transition={{ delay: 0.2 }}
      ...
      <div className="flex flex-col gap-12 justify-center pb-48" ref={experienceRef}>
        {/* EXPERIENCE TITLE */}
        <motion.h1 initial={{ x: "-300px" }} animate={isExperienceRefInView ? { x: "0" } : {}}
          transition={{ delay: 0.2 }} className="font-bold text-2xl">
          EXPERIENCE
        </motion.h1>
        {/* EXPERIENCE LIST */}
          ...
          <div className="flex justify-between h-48">
            ...
            <div className="w-1/3 ">
              ...
              <div className="p-3 text-sm italic">
                I led development, offering expertise in Jfullstack development.{" "}
              </div>
              {/* JOB DATE */}
